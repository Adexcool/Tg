...
TOKEN = '1148643659:AAEbweNaSzF7NiU3sAWlj4H8k_JGQyV9mpg'
...
def postsRES():
    ...
    f.write("""
     Реклама - 🤝Наш партнёр
  24 часа (1 день) + 1 рассылка - 100UAH
  48 часов (2 дня) + 1 рассылка - 130UAH
  120 часов (5 дней) + 1 рассылка - 200UAH
...
def handle_message_received(message):
  ...
  if user_status == 'member' or user_status == 'administrator' or user_status == 'creator':
   ...
   if text == "Добавить партнер" and chat_id == ADMIN_CHAT_ID:
    ...
    bot.send_message(chat_id, 'Владелец бота: @sonleino \nПо вопросам сотрудничества обращаться в ЛС сюда @tvoy_piar_menedzher  \nБот работает пока что только на Россию и Украину')
